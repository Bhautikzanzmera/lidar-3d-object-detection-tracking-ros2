...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', required=True, help='Path to the PointPillars checkpoint')
    parser.add_argument('--saved_path', default='results', help='your saved path for predicted results')
    parser.add_argument('--split', default='val', choices=['val', 'test'], help='project split to evaluate')
